...
bot = Client(
    ...
    bot_token=BOT_TOKEN,
    proxy=dict(
        scheme="http",                   # aapka proxy http hai
        hostname="203.115.123.163",      # yaha apna host daalo
        port=1452,                       # yaha apna port daalo
        username="Admin",                # proxy ka username
        password="Admin"                 # proxy ka password
    workers=300,
    sleep_threshold=60,
    in_memory=True
)
